...
const $6820ce0a6d1281bf$var$updateColorPicker = ()=>{
    ...
    document.querySelector('input[type="color"]').value = $6820ce0a6d1281bf$var$rgbToHex(markComputedStyle.backgroundColor);
};
const $6820ce0a6d1281bf$var$themes = {
    default: (0, (/*@__PURE__*/$parcel$interopDefault($bf256fe202690084$exports))),
    amber: (0, (/*@__PURE__*/$parcel$interopDefault($bf2c4fa05892f614$exports))),
    jade: (0, (/*@__PURE__*/$parcel$interopDefault($6a83fed8370f1d4e$exports))),
    purple: (0, (/*@__PURE__*/$parcel$interopDefault($710deefddc3405e8$exports))),
    sand: (0, (/*@__PURE__*/$parcel$interopDefault($f1a7c9a78549ed95$exports)))
};
const $6820ce0a6d1281bf$var$updateTheme = (theme)=>{
    document.querySelector('aside style').innerHTML = theme;
    requestAnimationFrame(()=>$6820ce0a6d1281bf$var$updateColorPicker());
...
document.querySelector('.dropdown.theme').addEventListener('change', (e)=>{
    ...
    $6820ce0a6d1281bf$var$updateTheme($6820ce0a6d1281bf$var$themes[e.target.value]);
});
$6820ce0a6d1281bf$var$updateTheme($6820ce0a6d1281bf$var$themes.default);
const $6820ce0a6d1281bf$var$colorSchemes = {
    auto: 'light dark',
    light: 'light',
    dark: 'dark'
};
const $6820ce0a6d1281bf$var$updateColorScheme = (colorScheme)=>{
...
document.querySelector('.dropdown.color-scheme').addEventListener('change', (e)=>{
    ...
    $6820ce0a6d1281bf$var$updateColorScheme($6820ce0a6d1281bf$var$colorSchemes[e.target.value]);
});
$6820ce0a6d1281bf$var$updateColorScheme($6820ce0a6d1281bf$var$colorSchemes.auto);


//# sourceMappingURL=pix.27d4dc86.js.map
